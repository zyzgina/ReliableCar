...
class SyncOkHttp extends BaseHttp {
     ...
     * @throws IOException
     */
    public String syncGetString(String url, AjaxParams params) throws IOException {
     ...
     * @throws IOException
     */
    public byte[] syncGetByteArray(String url, AjaxParams params) throws IOException {
        url = getRealUrl(url, params);
...
//        return syncRequest(new Request.Builder().url(url).get().build());
     ...
     * @throws IOException
     */
    public Response syncGetResponse(String url, AjaxParams params) throws IOException {
        url = getRealUrl(url, params);
...
/**--------------------------------------   post    -----------------------------------------*/
     ...
     * @throws IOException
     */
    public String syncPostString(String url, AjaxParams params) throws IOException {
     ...
     * @throws IOException
     */
    public byte[] syncPostByteArray(String url, AjaxParams params) throws IOException {
     ...
     * @throws IOException
     */
    public Response syncPostResponse(String url, AjaxParams params) throws IOException {
