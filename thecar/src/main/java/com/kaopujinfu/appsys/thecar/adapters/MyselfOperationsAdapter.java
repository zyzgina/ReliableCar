...
public class MyselfOperationsAdapter extends BaseAdapter {
    ...
    private String[] strs;
    private int[] ints = {R.drawable.my_icon_binding, R.drawable.my_icon_binding,R.drawable.my_icon_binding,R.drawable.my_icon_document, R.drawable.my_icon_shot, R.drawable.my_icon_check};
