...
public class PhotosAdapter extends BaseExpandableListAdapter {
    ...
    private UpdatePhotoUIListener mListener;

    public PhotosAdapter(Context context, ExpandableListView listView){
        mContext = context;
        mListView = listView;
        // 点击不收缩
    ...
    public void setUpdatePhotoeUIListener(UpdatePhotoUIListener mListener) {
        this.mListener = mListener;
    }

    public interface UpdatePhotoUIListener {
